    ...
    <header className="sticky top-0 z-50 border-b border-white/5 bg-background/90 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 text-sm">
        ...
        <div className="hidden items-center gap-6 md:flex">
          ...
          <a
            href="https://github.com/Lexiie/arxpool-sdk"
          ...
          <span className="relative h-4 w-5" aria-hidden="true">
            ...
            <span
              className={clsx(
                ...
                isOpen ? "top-1/2 -translate-y-1/2 opacity-0" : "top-1/2 -translate-y-1/2 opacity-100"
              )}
            />
            <span
              className={clsx(
      ...
      <div
        className={clsx(
          "md:hidden",
          isOpen ? "max-h-64 border-t border-white/5" : "max-h-0 overflow-hidden"
        )}
      >
